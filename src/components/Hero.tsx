    ...
    <section className="bg-f1-black border-b border-f1-border">
      <div className="wrap section-padding">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] min-h-[340px]">
          {/* Left column */}
          <div className="py-12 pr-0 lg:pr-10 lg:border-r border-f1-border flex flex-col justify-end">
            <motion.div
            ...
            >
              ...
              <p className="text-[13px] text-f1-muted leading-[1.7] max-w-[480px] mb-8">
          ...
          {/* Right column */}
          <div className="py-8 pl-0 lg:pl-10 flex flex-col justify-between gap-6">
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, delay: 0.2 }}
              className="pb-6 border-b border-f1-border"
            >
              <span className="font-mono text-[10px] uppercase tracking-[0.12em] text-f1-muted mb-1.5 block">
                Championship Leader
              </span>
              <p className="font-display text-[42px] font-extrabold leading-none tracking-tight text-white">
                {topDrivers[0]?.lastName.slice(0, 3).toUpperCase() || "NOR"}
              </p>
              <p className="text-[11px] text-f1-muted mt-1">
                {topDrivers[0]?.firstName} {topDrivers[0]?.lastName} &bull;{" "}
                {topDrivers[0]?.team} &bull; {topDrivers[0]?.points} PTS
              </p>
            </motion.div>
            ...
            >
              ...
              {nextRace ? (
                ...
                <p className="font-display text-[42px] font-extrabold text-white">
                  —
                </p>
              )}
            </motion.div>
